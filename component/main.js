        ...
        if (cartIcon) {
            cartIcon.addEventListener('click', function () {
                ...
                if (sidebarComponent) {
                    ...
                    const mySidebar = shadowRoot.querySelector('.sidebar');
                    ...
                    if (mySidebar) {
                        ...
                        console.error('Error: .sidebar element not found inside the shadow DOM');
                    }
                } else {
                    console.error('Error: Sidebar component not found');
                }
            });
        } else {
            console.error('Error: Cart icon not found');
        }
